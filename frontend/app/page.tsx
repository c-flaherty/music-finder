...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${hasSearchResults ? 'bg-[#FFFFFF]' : 'bg-[#FFF5D1]'} ${roobert.variable} font-roobert`}>
      ...
      <footer className="py-8 text-center">
        <p className="text-[#838D5A] text-sm font-roobert">
          no cannoli world socials yet!
        </p>
      </footer>
    </div>
  );
